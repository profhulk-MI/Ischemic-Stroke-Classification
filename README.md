...
** We present TrustNet, a small but powerful Convolutional Neural Network (0.66 MB) that uses
...
and inconsistency in recognizing the relevant visual features. 

** The model was validated on a set of 2023 brain CT scans and compared with networks that are generally used for classification purposes. TrustNet was able to achieve an accuracy
...
limiting the number incorrect predictions, which is crucial for stroke diagnosis. 
