...
This repository presents a comprehensive suite of **deep learning and machine learning models** for the **detection, localization, and classification of brain stroke from CT images**. The work focuses on building **clinically reliable AI systems** by integrating **uncertainty quantification** and **explainable AI** into lightweight and efficient architectures.
